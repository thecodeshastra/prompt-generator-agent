...
class TestCaseGenerator(BaseAgent):
    ...
    def __init__(self, provider: BaseProvider):
        ...
        self.benchmark_pdf = Path(__file__).parent / "memory/test_case_benchmark_consideration.pdf"
    ...
    def _load_benchmark(self) -> None:
        ...
        if self.benchmark_pdf.exists():
            try:
                ...
                logger.info(f"Loaded benchmark from PDF ({len(self.benchmark_content)} chars).")
    ...
    def _load_prompt_template(self) -> None:
        ...
        """
        template_file = Path(__file__).parent / "prompts" / "test_case_generator.md"
