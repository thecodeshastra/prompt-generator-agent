"""global settings module for prompt-optimization-agent"""
...
TIMEOUT_SECONDS = config("TIMEOUT_SECONDS", default=180, cast=int)
...
# Memory settings
USE_MEMORY = config("USE_MEMORY", default=True, cast=bool)  # Enable memory for prompt optimization
